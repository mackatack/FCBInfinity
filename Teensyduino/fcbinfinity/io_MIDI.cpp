...
/*! \brief Default destructor for MIDI_ClassNew.
...
/*! \brief Call the begin method in the setup() function of the Arduino.
 ...
 - Full thru mirroring
 */
void MIDI_ClassNew::begin(const byte inChannel)
{
...
const byte MIDI_ClassNew::genstatus(const kMIDIType inType,
 ...
 */
void MIDI_ClassNew::send(kMIDIType type,
					  byte data1,
					  byte data2,
					  byte channel)
{
 ...
 */
void MIDI_ClassNew::sendNoteOn(byte NoteNumber,
							byte Velocity,
							byte Channel)
{
...
/*! \brief Send a Note Off message (a real Note Off, not a Note On with null velocity)
 ...
 \param Channel		The channel on which the message will be sent (1 to 16).
 */
void MIDI_ClassNew::sendNoteOff(byte NoteNumber,
							 byte Velocity,
							 byte Channel)
{
...
/*! \brief Send a Program Change message
 ...
 \param Channel			The channel on which the message will be sent (1 to 16).
 */
void MIDI_ClassNew::sendProgramChange(byte ProgramNumber,
								   byte Channel)
{
...
/*! \brief Send a Control Change message
 ...
 \param Channel			The channel on which the message will be sent (1 to 16).
 */
void MIDI_ClassNew::sendControlChange(byte ControlNumber,
								   byte ControlValue,
								   byte Channel)
{
...
/*! \brief Send a Polyphonic AfterTouch message (applies to only one specified note)
 ...
 \param Channel			The channel on which the message will be sent (1 to 16).
 */
void MIDI_ClassNew::sendPolyPressure(byte NoteNumber,
								  byte Pressure,
								  byte Channel)
{
...
/*! \brief Send a MonoPhonic AfterTouch message (applies to all notes)
 ...
 \param Channel			The channel on which the message will be sent (1 to 16).
 */
void MIDI_ClassNew::sendAfterTouch(byte Pressure,
								byte Channel)
{
...
/*! \brief Send a Pitch Bend message using a signed integer value.
 ...
 \param Channel		The channel on which the message will be sent (1 to 16).
 */
void MIDI_ClassNew::sendPitchBend(int PitchValue,
							   byte Channel)
{
...
/*! \brief Send a Pitch Bend message using an unsigned integer value.
 ...
 \param Channel		The channel on which the message will be sent (1 to 16).
 */
void MIDI_ClassNew::sendPitchBend(unsigned int PitchValue,
							   byte Channel)
{
...
/*! \brief Send a Pitch Bend message using a floating point value.
 ...
 \param Channel		The channel on which the message will be sent (1 to 16).
 */
void MIDI_ClassNew::sendPitchBend(double PitchValue,
							   byte Channel)
{
 ...
 */
void MIDI_ClassNew::sendSysEx(int length,
 ...
 */
void MIDI_ClassNew::sendTuneRequest()
{
 ...
 */
void MIDI_ClassNew::sendTimeCodeQuarterFrame(byte TypeNibble, byte ValuesNibble)
{
 ...
 */
void MIDI_ClassNew::sendTimeCodeQuarterFrame(byte data)
{
 ...
 */
void MIDI_ClassNew::sendSongPosition(unsigned int Beats)
{
...
void MIDI_ClassNew::sendSongSelect(byte SongNumber)
{
...
/*! \brief Send a Real Time (one byte) message.
 ...
 @see kMIDIType
 */
void MIDI_ClassNew::sendRealTime(kMIDIType Type)
{
	switch (Type) {
...
bool MIDI_ClassNew::read(const byte inChannel)
{
...
bool MIDI_ClassNew::parse(byte inChannel)
{
...
bool MIDI_ClassNew::input_filter(byte inChannel)
{
...
void MIDI_ClassNew::reset_input_attributes()
{
 ...
 */
kMIDIType MIDI_ClassNew::getType() const
{
 ...
 */
byte MIDI_ClassNew::getChannel() const
{
...
byte MIDI_ClassNew::getData1() const
{
...
byte MIDI_ClassNew::getData2() const
{
 ...
 */
const byte * MIDI_ClassNew::getSysExArray() const
{
 ...
 */
unsigned int MIDI_ClassNew::getSysExArrayLength() const
{
...
bool MIDI_ClassNew::check() const
{
 ...
 */
void MIDI_ClassNew::setInputChannel(const byte Channel)
{
...
void MIDI_ClassNew::setHandleNoteOff(void (*fptr)(byte channel, byte note, byte velocity))			{ mNoteOffCallback = fptr; }
void MIDI_ClassNew::setHandleNoteOn(void (*fptr)(byte channel, byte note, byte velocity))			{ mNoteOnCallback = fptr; }
void MIDI_ClassNew::setHandleAfterTouchPoly(void (*fptr)(byte channel, byte note, byte pressure))	{ mAfterTouchPolyCallback = fptr; }
void MIDI_ClassNew::setHandleControlChange(void (*fptr)(byte channel, byte number, byte value))	{ mControlChangeCallback = fptr; }
void MIDI_ClassNew::setHandleProgramChange(void (*fptr)(byte channel, byte number))				{ mProgramChangeCallback = fptr; }
void MIDI_ClassNew::setHandleAfterTouchChannel(void (*fptr)(byte channel, byte pressure))			{ mAfterTouchChannelCallback = fptr; }
void MIDI_ClassNew::setHandlePitchBend(void (*fptr)(byte channel, int bend))						{ mPitchBendCallback = fptr; }
void MIDI_ClassNew::setHandleSystemExclusive(void (*fptr)(byte * array, byte size))				{ mSystemExclusiveCallback = fptr; }
void MIDI_ClassNew::setHandleTimeCodeQuarterFrame(void (*fptr)(byte data))							{ mTimeCodeQuarterFrameCallback = fptr; }
void MIDI_ClassNew::setHandleSongPosition(void (*fptr)(unsigned int beats))						{ mSongPositionCallback = fptr; }
void MIDI_ClassNew::setHandleSongSelect(void (*fptr)(byte songnumber))								{ mSongSelectCallback = fptr; }
void MIDI_ClassNew::setHandleTuneRequest(void (*fptr)(void))										{ mTuneRequestCallback = fptr; }
void MIDI_ClassNew::setHandleClock(void (*fptr)(void))												{ mClockCallback = fptr; }
void MIDI_ClassNew::setHandleStart(void (*fptr)(void))												{ mStartCallback = fptr; }
void MIDI_ClassNew::setHandleContinue(void (*fptr)(void))											{ mContinueCallback = fptr; }
void MIDI_ClassNew::setHandleStop(void (*fptr)(void))												{ mStopCallback = fptr; }
void MIDI_ClassNew::setHandleActiveSensing(void (*fptr)(void))										{ mActiveSensingCallback = fptr; }
void MIDI_ClassNew::setHandleSystemReset(void (*fptr)(void))										{ mSystemResetCallback = fptr; }
 ...
 */
void MIDI_ClassNew::disconnectCallbackFromType(kMIDIType Type)
{
...
void MIDI_ClassNew::launchCallback()
{
...
/*! \brief Set the filter for thru mirroring
 ...
 @see kThruFilterMode
 */
void MIDI_ClassNew::setThruFilterMode(kThruFilterMode inThruFilterMode)
{
...
void MIDI_ClassNew::turnThruOn(kThruFilterMode inThruFilterMode)
{
...
void MIDI_ClassNew::turnThruOff()
{
...
void MIDI_ClassNew::thru_filter(byte inChannel)
{
